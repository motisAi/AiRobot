...
- GPIO14 (Pin 8)  -> RS485 DI (TX from Pi)
- GPIO15 (Pin 10) -> RS485 RO (RX to Pi)
- GPIO18 (Pin 12) -> RS485 Enable (DE/RE)
...
def example_basic_commands():
    ...
    try:
        ...
        motor.send_hex_command("01 03 00 00 00 01")
        motor.read_response()
        print("\n2. Setting motor speed...")
        motor.send_hex_command("01 06 00 01 03 E8")
        motor.read_response()
        print("\n3. Starting motor...")
        motor.send_hex_command("01 06 00 02 00 01")
        motor.read_response()
        time.sleep(2)
        print("\n4. Stopping motor...")
        motor.send_hex_command("01 06 00 02 00 00")
        motor.read_response()
